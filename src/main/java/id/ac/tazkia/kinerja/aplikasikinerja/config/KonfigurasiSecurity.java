...
public class KonfigurasiSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/role/form").hasAnyAuthority("VIEW_STAFF","VIEW_KABAG","VIEW_SUPERADMIN")
                ...
                .antMatchers("/kpi/form").hasAnyAuthority("VIEW_STAFF","VIEW_KABAG","VIEW_SUPERADMIN")
                .antMatchers("/kpi/hapus").hasAnyAuthority("VIEW_STAFF","VIEW_KABAG","VIEW_SUPERADMIN")
                .antMatchers("/kpi/hasil").hasAnyAuthority("VIEW_STAFF","VIEW_KABAG","VIEW_SUPERADMIN")
                .antMatchers("/kpi/list").hasAnyAuthority("VIEW_STAFF","VIEW_KABAG","VIEW_SUPERADMIN")
                .antMatchers("/kpi/update").hasAnyAuthority("VIEW_STAFF","VIEW_KABAG","VIEW_SUPERADMIN")
